<x-app-layout>
    ...
    <div class="container bi-sign-turn-left-fill end mx-auto p-6">
        <div class="flex w-full items-center justify-between mb-4">
            ...
            <h1 class="text-2xl font-semibold mb-4">Historique des Payments</h1>
            <button class=" w-full"> <a href="{{ route('withdrawals.create') }}"
                    class="bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-3 p-3 text-[15px] w-full rounded">Demande
                    de retire</a>
            </button>
        </div>
