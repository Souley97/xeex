<x-app-layout>
    <div class="container mx-auto p-8">
        <h2 class="text-2xl font-semibold mb-4">Modifier l'annoce</h2>
        ...
        <form action="{{ route('annoces.update', $video->id) }}" method="post" enctype="multipart/form-data" class="max-w-lg mx-auto">
            @csrf
            @method('PUT')
